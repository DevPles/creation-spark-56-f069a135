        ...
        <div className="flex items-center justify-between h-14 gap-3">
          <button onClick={() => navigate("/dashboard")} className="flex items-center gap-2.5 shrink-0">
            <div className="w-8 h-8 bg-primary-foreground/20 rounded-md flex items-center justify-center">
              <span className="text-primary-foreground font-display font-bold text-xs">MO</span>
            </div>
            <span className="font-display font-semibold text-primary-foreground text-sm hidden sm:block">MetricOss</span>
          </button>
